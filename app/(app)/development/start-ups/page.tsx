    ...
    return (
        <>
            ...
            <section className="container flex flex-col gap-2 text-masonry-grey text-body">
                <p>At <span className="text-white">Masonry Studio</span>, we provide small businesses with high-quality, fully responsive websites built using the exact same modern technologies we use on our bespoke builds.</p>
                ...
                <TracingBeam>
                    <div className="flex flex-col mt-4 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-body">We begin by understanding your business and your goals. We will work with you to identify your target audience and the message you want to convey.</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <h3 className="text-subheader">Design</h3>
                            <p className="text-body">We will create a design that is tailored to your business and your audience. We will work with you to ensure that the design meets your needs and your vision.</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <h3 className="text-subheader">Development</h3>
                            <p className="text-body">We will develop your website using the latest technologies and best practices. We will ensure that your website is responsive, fast, and secure.</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            <h3 className="text-subheader">Deployment</h3>
                            <p className="text-body">We will deploy your website to a secure and reliable server. We will ensure that your website is live and accessible to your audience.</p>
                        </div>
                    </div>
                </TracingBeam>
            </section>
