			...
			<div className="flex flex-col gap-6 items-start">
				<div className="flex flex-col gap-2 items-start">
					<h2 className="font-display font-bold text-4xl">
						Start Up&apos;s<span className="text-blue-500">.</span>
					</h2>
					<p className="text-sans font-normal text-gray-400">
						Choose from our templates, designed specifically for
						startups and built with Next.js and a headless CMS. They
						offer speed, flexibility, and scalability to meet the
						needs of growing businesses..
						<br />
						<br />
						Select a layout, and we&apos;ll customize it with your
						branding-colors, logo, and content—to create a
						professional, unique site.
						<br />
						<br />
						Easily manage and update your site as your business
						evolves. Launch a website that grows with your startup!
					</p>
				</div>
			...
			<div className="flex flex-col gap-6 items-start">
				<div className="flex flex-col gap-2 items-start">
					...
					<p className="text-sans font-normal text-gray-400">
						...
						high-performance platform, designed for speed and
						scalability. Our hosting ensures fast load times and
						smooth user experiences.
						<br />
						<br />
						To prevent downtime, our servers are linked to a backup
						server using Docker Swarm, ensuring continuous
						availability even during maintenance or unexpected
						issues.
						<br />
						<br />
						Enjoy secure, scalable hosting that grows with your
						business!
					</p>
				</div>
...
export default function Home() {
	return (
		<>
			...
			<section className="flex flex-row gap-8 xl:gap-0 items-center justify-evenly w-full h-full px-32 pb-16">
