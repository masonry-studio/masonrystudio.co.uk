...
export default async function Contact() {
	return (
		<>
			<section className="container flex flex-col items-center justify-center w-full my-24 p-8 animate-fade-in opacity-0 [--animation-delay:200ms]">
				<h1 className="text-header pb-0">Contact Us</h1>
				<Breadcrumb />
				<div className="mt-5 text-center">
					<p className="text-body text-masonry-grey">
						Got any questions about our services or scaling your
			...
			<section className="container flex flex-row justify-center gap-6">
				<form className="w-full flex flex-col gap-y-6">
					<div className="flex gap-4">
						<input
							className="w-full bg-transparent border rounded-lg px-4 py-2"
							type="text"
							name="fname"
							id="fname"
				...
				<div className="w-fit flex flex-col gap-4 px-4">
					<div className="flex items-center gap-2">
						<Mail color="var(--masonry-blue)" />
						<p>hello@masonrystudio.co.uk</p>
					</div>
					<div className="flex items-center gap-2">
						<Clock5 color="var(--masonry-orange)" />
						<p>Mon-Fri, 9am - 5pm</p>
					</div>
				</div>
			</section>
