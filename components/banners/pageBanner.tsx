...
export default function PageBanner({ content }:{ content: { title: string, description: string, image: StaticImageData, alt: string } }) {
    ...
    return (
        <>
            <div className="w-full flex flex-col gap-5 items-start justify-center h-auto">
                ...
                <p className='min-h-[78px]'>{content.description}</p>
            ...
            <div className='max-w-[600px] flex'>
                <Image className='my-auto' src={content.image} alt={content.alt} priority />
            </div>
